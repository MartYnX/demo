        ...
        <div className="resume">
            <div className="base">
                <div className="profile">
                    ...
                    <div className="info">
                        <h4 className="name">Kelly Chen</h4><small className="job">Front-end Web Designer</small>
                    </div>
                </div>
                <div className="about">
                ...
                <div className="follow">
                    <h3>Follow</h3>
                    <div className="box"><a href="javascript:void(0);"><i className="fa fa-facebook"></i></a><a href="javascript:void(0);"><i className="pif-plurkapp"></i></a><a href="javascript:void(0);"><i className="fa fa-twitter"></i></a><a href="javascript:void(0);"><i className="fa fa-pinterest-p"></i></a><a href="javascript:void(0);"><i className="fa fa-tumblr"></i></a><a href="https://codepen.io/xichen/" target="_blank"><i className="fa fa-codepen"></i></a></div>
                </div>
            </div>
            <div className="func">
                <div className="work">
                ...
                <div className="interests">
                    ...
                    <div className="interests-items">
                        ...
                        <div className="guitar"><i className="guitar">
